...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    less: {
      ...
      compileDemo: {
        options: {
          ...
          sourceMap: true,
          outputSourceFiles: true,
          sourceMapURL: 'demo1.css.map',
          sourceMapFilename: 'docs/assets/css/demo1.css.map'
        },
        files: {
          'docs/assets/css/demo.css': 'docs/assets/css/src/demo1.less'
        }
      }
    },
    ...
    autoprefixer: {
      ...
      assets: {
        src: ['docs/assets/css/docs.css', 'docs/assets/css/demo1.css']
      }
    },
    ...
    csscomb: {
      ...
      assets: {
        files: {
          ...
          'docs/assets/css/demo.css': 'docs/assets/css/demo1.css'
        }
      }
    },
